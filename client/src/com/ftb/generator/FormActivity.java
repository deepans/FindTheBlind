...
public abstract class FormActivity extends Activity
{
	...
	public static String SCHEMA_KEY_DESC 		= "description";
	...
	protected FormWidget getWidget( String name, JSONObject property ) 
	{
		try
		{
			...
			if( type.equals( FormActivity.SCHEMA_KEY_STRING ) ){
				return new FormEditText( this, name, 1);
			}

			if( type.equals( FormActivity.SCHEMA_KEY_DESC) ){
				return new FormEditText( this, name, 3);
			}

			if( type.equals( FormActivity.SCHEMA_KEY_LABEL ) ){
				return new FormLabel( this, name  );
			}
